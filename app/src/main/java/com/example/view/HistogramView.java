...
public class HistogramView extends View {
    ...
    private float tb;//基准
    private final int characterColor = 0xff6E6E6E;//字体颜色
    private final int lineColor = 0xffBBBBBB; // 线的颜色
    private final int smallColor = 0xffFE6895; // 最后一个矩形的颜色
    private final int bigColor = 0xffFAB0C7;//矩形的颜色
    private final int baseColor = 0xffF8F8F8;//底色
    private float x,y;
...
//			invalidate();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //显示年份
        canvas.drawText("",3.5f*x,(12+0.5f)*y,paint_text);
        //显示标注
